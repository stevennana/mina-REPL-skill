...
class ManifestTests(unittest.TestCase):
    def test_manifest_loads(self) -> None:
        ...
        self.assertIn("token_budget_policy", manifest.capabilities)
        self.assertIn("small_model_routing", manifest.capabilities)
        self.assertIn("context_window_control", manifest.capabilities)
        self.assertIn("workspace_awareness_contract", manifest.capabilities)
        self.assertIn("autonomous_discovery_policy", manifest.capabilities)
    ...
    def test_contracts_include_documented_commands(self) -> None:
        ...
        self.assertIn("workspace_context", contracts["contracts"])
        self.assertIn("discovery_policy", contracts["contracts"])
        ...
        self.assertIn("token_budget_policy", contracts["contracts"])
        self.assertIn("small_model_policy", contracts["contracts"])
